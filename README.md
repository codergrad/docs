...
| Agile               | ([ссылка](https://agilemanifesto.org/iso/ru/manifesto.html)) | —                                                                                                         | Наша команда придерживается Agile-принципов разработки, рекомендуем ознакомиться, это не долго                                                                                                                |


## Профильная документация

Так как мы разрабатываем ПО для разных платформ, рекомендуем ознакомиться с узконаправленной документации

| Название           | Ссылка                                                                                   | Описание                                                                                                                                                    |
|:-------------------|:-----------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Мобильная разработка         | ([ссылка](./MobileDev/GettingStarted.md)                                   | Здесь вы найдёте руководства и ссылки на документацию, которая связаную с мобильной разработкой ПО.    
| Разработка веб-приложений         | ([ссылка](./WebDev/GettingStarted.md)                                   | HTML, CSS, JS и всё, что связано с разработкой сайтов и PWA